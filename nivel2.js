...
/
const comidasFavoritas = ["lomo", "asado", "papas fritas"]
...
comidasFavoritas [1] = "salchicha"
console.log(comidasFavoritas)
comidasFavoritas.push("pure de pagas")
console.log(comidasFavoritas)
...
// Tarea: calcula funcion promedio que tome como parametro un array
const notasParciales = [10,8,5,2,10,4,9,10,9,7,5]
let notasTotales = 0

function promedioNotas (notasParciales, notasTotales) {
    return (notasTotales/notasParciales.length)
}

for(let i=0; i < notasParciales.length; i++) {
    notasTotales = notasTotales + notasParciales[i]
}

console.log((promedioNotas(notasParciales, notasTotales)).toFixed(2))
...
const comidasFavoritas = ["Ravioles", "Choripan", "Chinchus"]
