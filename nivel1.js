...
//console.log('Que haces guacho, tanto tiempo?')
...
console.log('nombreDeVaraible es ' + nombreDeVariable)
...
//edad = 31
//nombre = 'Jonatan'
//alert("Mi edad es " + edad + " y mi nombre es " + nombre)
...
function triplicar(personas) {return personas * 3}
triplicar(12)
...
//sumar(135,125)
//console.log(sumar(135,125))

function restar(numero1, numero2) {return numero1 - numero2}
//console.log(restar(1560,15000))

//let anioRecibida = 2015
//let anioActual = 2022
//let aniosRecibido = restar(anioActual,anioRecibida)

//console.log("Años recibido : " + aniosRecibido)
...
//let edadUsuario = prompt ("Cuando naciste gil?","29")

/*function salarioAnual(salarioMensual) {return salarioMensual*12}
function salarioDiario(salarioMensual,diasMes) {return salarioMensual/diasMes}
function salarioHora(salarioMensual,diasMes,horasDia) {return salarioMensual/diasMes/horasDia}

let salarioMensual = Number(prompt("Salario Mensual"))
let diasMes = Number(prompt("Días hábiles al mes trabajados"))
let horasDia = Number(prompt("Horas por dia trabajadas"))

console.log(salarioAnual(salarioMensual))
console.log(salarioDiario(salarioMensual,diasMes))
console.log(salarioHora(salarioMensual,diasMes,horasDia))*/

/*function calcularEdadPersona(anioActual,anioNacimiento) {return anioActual - anioNacimiento}

let anioActual = prompt("En que año estamos?")
let anioNacimiento = prompt("En que año naciste?")
let edadPersona = calcularEdadPersona(anioActual, anioNacimiento)

//console.log("Mi Edad es " + edadPersona)
...
/*
    ...
    === //Exactamente igual que (1 y "1" no son iguales, pero 1 es exactamente igual a 1 y "1" es exactamente igual a  "1"). 
    Este operador compara el valor y el TIPO del valor.
    ...
    Atención: No mezclar '=' y '==' ó '===' porque tienen distintos significados.
         ...
         '===' significa preguntar si es "exactamente igual a". miVariable === 1 es verdadero si miVariable es 1, y falso si es cualquier 
         otra cosa distinta de 1.
...
//if (operador === "+") {resultado = (sumar(numero1, numero2))} else {resultado = restar(numero1, numero2)}
...
if (operador === "+") {resultado = (sumar(numero1, numero2))}
else if (operador === "-") {resultado = (restar(numero1, numero2))}
else if (operador === "*") {resultado = (multiplicar(numero1, numero2))}
else if (operador === "/") {resultado = (dividir(numero1, numero2))}
else {console.log("No entiendo la operacion" + operador)}
...
} else if (nombre === "gonzalo") {
    console.log("Hola "+ nombre +" te llamas igual a mi hermano")
} else 
...
if (edad === 31) {
    ...
    console.log("Tienes mas edad que yo")
} else {
    console.log("Tienes menos edad que yo")
}

let dni = prompt ("Tenes dni?")
let edad

if (dni.toLowerCase() === "si") {
    edad = prompt("Que edad tenes?")
} else if (dni.toLowerCase() === "no") {
    console.log("No puedes ingresar al bar, vete")
} else {
    console.log("No entiendo la respuesta")
}
if (edad >= 18) {
    console.log("Puedes ingresar al bar, adelante")
} else if (edad <18) {
    console.log("No puedes ingresar al bar, vete")
}*/